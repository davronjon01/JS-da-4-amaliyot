...
const personalNewsDB = {
    ...
    writeYourGenres: function() {
        ...
        for(let i = 0; i < 2; i++) {
            let genre = prompt(`Sizning sevimli janringiz, vergul yordamida kiriting`).toLowerCase();;

            if(genre === "" || genre === null) {
                console.log("Siz no'tog'ri ma'lumot kiritdingiz");
                i--
            } else {
...
//     if(genre === "" || genre === null) {
//         console.log("Siz notogri malumot kiritdinggiz");
//         i--;
//     } else{
//         personalNewsDB.genres = genre.split(", ")
//     }
